				...
				<div class="col-md-4 mb-4">
					...
					<div class="card h-100 card-hover">
						<img src="${destination.image}" class="card-img-top"
							alt="Card Image" style="height:40%;">
						<div class="card-body">
							<h5 class="card-title text-center">${destination.destinationName}</h5>
							<p class="card-text" style="text-align: justify;">${destination.description}</p>
							<a class="btn btn-fancy" href="/destinations/${destination.id}/view">
								View More</a>
						</div>
					</div>
