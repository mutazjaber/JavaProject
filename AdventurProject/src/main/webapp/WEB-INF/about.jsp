...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p class="lead my-3">Our adventure planner aim to give you the best and most up-to-date information on the major travel destinations around the world.</p>
                <p class="lead mb-0">
                    <a href="#" class="text-white fw-bold" onclick="showContinueReading()">Continue reading...</a>
                </p>
                <p id="continueReading" class="d-none lead mb-0">The best adventure destinations inspire and inform you. Use them to plan the trip of your dreams.</p>
            </div>
        </div>
    </div>
</div>
	...
	<div class="container mt-5">
		...
		<div class="row featurette shadow-lg p-3 mb-5 bg-body rounded">
			...
			<div class="col-md-5">
				<img class="featurette-image img-fluid mx-auto w-100"
