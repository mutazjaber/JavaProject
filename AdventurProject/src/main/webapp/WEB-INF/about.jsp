...
<nav class="navbar navbar-expand-xl navbar-light py-1 shadow-lg p-3 mb-5  rounded" style="background-color: #e3f2fd;">
	...
	<div class="container mt-5 ">
		<div class="p-4 p-md-5 mb-4 text-white rounded " style="background-image: url('https://www.pixel4k.com/wp-content/uploads/2018/11/man-mountains-clouds-travel-4k_1541117588.jpg.webp'); background-size: cover; background-position: center;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="display-4 fst-italic">Who we are ?</h1>
                <p class="lead my-3">Interested in technology, knowing that programming can give you the freedom to learn new things consistently from any place. Multiple lines of text that form the lede.</p>
                <p class="lead mb-0">
                    <a href="#" class="text-white fw-bold" onclick="showContinueReading()">Continue reading...</a>
                </p>
                <p id="continueReading" class="d-none lead mb-0">Multiple lines of text that form the lede, informing new readers quickly and efficiently about whats most interesting in this posts contents.</p>
            </div>
        </div>
    </div>
</div>
		...
		<div class="row">
			<div class="col-md-4 mb-4">
				<div class="card h-100 card-hover">
					<div class="d-flex justify-content-center align-items-center"
						style="height: 200px;">
						<img
							src="https://scontent.fjrs29-1.fna.fbcdn.net/v/t39.30808-1/418571448_6748123608643951_9012962475956712285_n.jpg?stp=dst-jpg_p240x240&_nc_cat=111&ccb=1-7&_nc_sid=5740b7&_nc_ohc=rECea1fyhW4AX-FfrP2&_nc_ht=scontent.fjrs29-1.fna&oh=00_AfArP3c4RnsjzEkYZ8PE7iOmJQ6t5R7HFtNNp6OG74Wxiw&oe=65B2F59C"
							class="card-img-top rounded-circle"
							style="width: 150px; height: 150px; object-fit: cover;"
							alt="Card Image">
					</div>
					<div class="card-body text-center">
						<h5 class="card-title">Mutaz Jaber</h5>
						<p class="card-text">Hello I am Mutaz Jaber, the guy behind
							Travel SEO. I help growing travel businesses profit from online
							marketing with page rankings. If you want to know more about me,
							feel free to ask web development Full-Stack Backend-Frontend.</p>
			...
			<div class="col-md-4 mb-4">
				<div class="card h-100 card-hover">
					...
					<div class="card-body text-center">
						<h5 class="card-title">Shahrazad Masalmah</h5>
						<p class="card-text">Hello I am ShahrazadMasalmah, I help
							growing travel businesses profit from online marketing with #1
							page rankings. If you want to know more about me, feel free to
							ask.</p>
						<div class="social-icons">
							<a href="#" title="Facebook" aria-label="Facebook"><svg
									viewBox="0 0 24 24" width="24px" height="24px"
			...
			<div class="col-md-4 mb-4">
				<div class="card h-100 card-hover">
					...
					<div class="card-body text-center">
						<h5 class="card-title">Muhammad-Habib Snuber</h5>
						<p class="card-text">Hello I am Muhammad-Habib Snuber, the guy
							behind Travel SEO. I help growing travel businesses profit from
							online marketing with #1 page rankings. If you want to know more
	...
	<div class="container mt-5">
		...
		<div class="row featurette shadow-lg p-3 mb-5 bg-body rounded">
			<div class="col-md-7">
				<h2 class="featurette-heading">
					Project Idea : <span class="text-muted">Travel Planning </span>
				</h2>
				<p class="card-text">Travel Planning This Travel Planning System
					enables administrators to create destination plans, including
					activities, hotels, and restaurants with associated costs. Users
					can choose and book a planned destination, customize activities and
					hotels, and view the total cost. The system displays all available
					options for a selected destination, allowing users to create
					personalized trip plans. User authentication, cost calculation, and
					trip history functionalities are incorporated. The user interface
					includes pages for registration, destination selection, plan
					customization, and more. Admins have a dedicated dashboard for plan
					management.
			</div>
			<div class="col-md-5 ">
				<img class="featurette-image img-fluid mx-auto"
					src="https://365datascience.com/resources/blog/thumb@1024_t5bz2clpb8p-top-10-machine-learning-project-ideas-2022.webp"
		...
		<div class="row featurette shadow-lg p-3 mb-5 bg-body rounded">
			<div class="col-md-7">
				<h2 class="featurette-heading">
					What Sets Us <span class="text-muted">Apart</span>
				</h2>
				<p class="card-text">Embracing the latest technological
					advancements, Adventure Planer incorporates innovative features,
					from real-time inventory tracking to intelligent analytics. We stay
					ahead of the curve, offering a Adventure Planer that not only meets
					but exceeds the expectations of modern businesses..</p>
			</div>
			<div class="col-md-5">
				<img class="featurette-image img-fluid mx-auto"
					src="https://t4.ftcdn.net/jpg/02/11/39/51/240_F_211395193_ILTeSLFdGh1LIVxYwCcjGLcUCDBxiwTr.jpghttps://t4.ftcdn.net/jpg/02/11/39/51/240_F_211395193_ILTeSLFdGh1LIVxYwCcjGLcUCDBxiwTr.jpg">
			</div>
		</div>
	...
	<script>
		function showContinueReading() {
			var continueReadingParagraph = document
					.getElementById("continueReading");
			continueReadingParagraph.classList.toggle("d-none");
		}
	</script>
