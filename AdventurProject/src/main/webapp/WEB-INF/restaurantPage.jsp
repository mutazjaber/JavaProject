...
<html>
    ...
    <div class="container border p-4" style="background-color: #e3f2fd;">
	    	...
	    	<form:form action="/restaurants/new" method="post" modelAttribute="restaurant">
		...
		<div class="container">
    			<img class="w-100 h-100" src="https://th.bing.com/th/id/R.a9e2af5ae7bc3f9dec6ece34824185f9?rik=Yo25eOufbLPgiA&pid=ImgRaw&r=0" alt="Sea Image"  />
    		</div>
		</div>
