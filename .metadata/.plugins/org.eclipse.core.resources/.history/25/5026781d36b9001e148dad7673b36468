...
.table th, .table td {
	...
	/* Use a good font (adjust as needed) */
}
...
.table tbody tr:hover {
	background-color: #e9ecef; /* Set background color on hover */
}
...
<body>
	<!-- Navbar -->
	<nav
		class="navbar navbar-expand-xl navbar-light py-1 shadow-lg p-3 mb-5  rounded"
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarLight">
				<div class="d-flex mx-auto">
					<ul class="navbar-nav mb-2 mb-xl-0">
						...
						<li class="nav-item"><a class="nav-link" href="/plan"> <svg
									xmlns="http://www.w3.org/2000/svg" width="16" height="16"
						...
						<li class="nav-item"><a class="nav-link" href="/destinations">
			...
			<ul class="navbar-nav">
				<li class="nav-link"><a class="btn btn-fancy" href="/login">Sign
						In <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
			...
			<tbody>
				...
				<c:forEach var="destination" items="${destinations}">
					<tr>
						...
						<td><a href="/destinations/${destination.id}"
