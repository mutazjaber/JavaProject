...
<body>
    ...
    <div class="container mt-5 ">
        <div class="p-4 p-md-5 mb-4 text-white rounded card-hover" style="background-image: url('https://www.pixel4k.com/wp-content/uploads/2018/11/man-mountains-clouds-travel-4k_1541117588.jpg.webp'); background-size: cover; background-position: center;">
            <div class="col-md-6 px-0">
                <h1 class="display-4 fst-italic">Who are we   ?</h1>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 card-hover">
                    <div class="d-flex justify-content-center align-items-center" style="height: 200px;">
                        <img src="https://scontent.fjrs29-1.fna.fbcdn.net/v/t39.30808-1/418571448_6748123608643951_9012962475956712285_n.jpg?stp=dst-jpg_p240x240&_nc_cat=111&ccb=1-7&_nc_sid=5740b7&_nc_ohc=rECea1fyhW4AX-FfrP2&_nc_ht=scontent.fjrs29-1.fna&oh=00_AfArP3c4RnsjzEkYZ8PE7iOmJQ6t5R7HFtNNp6OG74Wxiw&oe=65B2F59C" 
                            class="card-img-top rounded-circle" style="width: 150px; height: 150px; object-fit: cover;" alt="Card Image">
                    </div>
                    <div class="card-body text-center">
                        <h5 class="card-title">Mutaz Jaber</h5>
                        <p class="card-text">
                            Hello I am Mutaz Jaber, the guy behind Travel SEO. I help growing travel businesses profit from online marketing with  page rankings. If you want to know more about me, feel free to ask
...
Full-Stack Backend-Frontend.
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 card-hover">
                    <div class="d-flex justify-content-center align-items-center" style="height: 200px;">
                        <img src="2962475956712285_n.jpg?stp=dst-jpg_p240x240&_nc_cat=111&ccb=1-7&_nc_sid=5740b7&_nc_ohc=rECea1fyhW4AX-FfrP2&_nc_ht=scontent.fjrs29-1.fna&oh=00_AfArP3c4RnsjzEkYZ8PE7iOmJQ6t5R7HFtNNp6OG74Wxiw&oe=65B2F59C" 
                            class="card-img-top rounded-circle" style="width: 150px; height: 150px; object-fit: cover;" alt="Card Image">
                    </div>
                    <div class="card-body text-center">
                        <h5 class="card-title">Shahrazad Masalmah</h5>
                        <p class="card-text">
                            Hello I am ShahrazadMasalmah,  I help growing travel businesses profit from online marketing with #1 page rankings. If you want to know more about me, feel free to ask.
                        </p>
                        <div class="social-icons">
                            <a href="#" title="Facebook" aria-label="Facebook"><svg viewBox="0 0 24 24" width="24px" height="24px" class="d Vb UmNoP"><path d="M12.001 2.061C6.478 2.061 2 6.537 2 12.061c0 4.993 3.661 9.132 8.445 9.879v-6.99H7.89v-2.889h2.556l.001-2.203c0-2.506 1.484-3.896 3.769-3.896 1.095 0 2.23.21 2.23.21v2.445h-1.253c-1.242 0-1.639.777-1.639 1.568l.003 1.876h2.777l-.444 2.889h-2.333v6.99C18.34 21.192 22 17.054 22 12.061c0-5.524-4.477-10-9.999-10z"></path></svg></a>
                            <a href="#" rel="noopener" class="HqkqA Cl _F bYExr" title="Twitter" aria-label="Twitter"><svg viewBox="0 0 24 24" width="24px" height="24px" class="d Vb UmNoP"><path d="M2 18.1c2.2.2 4.3-.5 5.9-1.899-1.2-.101-3.6-2.4-4-2.9h1.6c-1.9-.5-3.2-2.2-3.2-4.1.6.099 1.2.299 1.7.499h.2C2.7 8.3 2.2 6 3.1 4.1c2.1 2.6 5.3 4.2 8.6 4.4V7.4c.1-2.2 2-4 4.2-4 .9 0 1.7.3 2.4.8.4.3.8.3 1.2.2l1.9-.7c-.4.9-.9 1.6-1.6 2.3.601-.1 1.3-.4 1.9-.5l.3.2c-.6.5-1.2 1.1-1.7 1.5-.1.3-.2.7-.2 1.1 0 1.9-.5 3.8-1.3 5.601A11.982 11.982 0 019.5 20.1c-2.4.2-4.9-.199-7-1.3l-.5-.7"></path></svg></a>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 card-hover">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">
                            Hello I am Muhammad-Habib Snuber, the guy behind Travel SEO. I help growing travel businesses profit from online marketing with #1 page rankings. If you want to know more about me, feel free to ask.
                        </p>
                        <div class="social-icons">
                            <a href="#" title="Facebook" aria-label="Facebook"><svg viewBox="0 0 24 24" width="24px" height="24px" class="d Vb UmNoP"><path d="M12.001 2.061C6.478 2.061 2 6.537 2 12.061c0 4.993 3.661 9.132 8.445 9.879v-6.99H7.89v-2.889h2.556l.001-2.203c0-2.506 1.484-3.896 3.769-3.896 1.095 0 2.23.21 2.23.21v2.445h-1.253c-1.242 0-1.639.777-1.639 1.568l.003 1.876h2.777l-.444 2.889h-2.333v6.99C18.34 21.192 22 17.054 22 12.061c0-5.524-4.477-10-9.999-10z"></path></svg></a>
                            <a href="#" rel="noopener" class="HqkqA Cl _F bYExr" title="Twitter" aria-label="Twitter"><svg viewBox="0 0 24 24" width="24px" height="24px" class="d Vb UmNoP"><path d="M2 18.1c2.2.2 4.3-.5 5.9-1.899-1.2-.101-3.6-2.4-4-2.9h1.6c-1.9-.5-3.2-2.2-3.2-4.1.6.099 1.2.299 1.7.499h.2C2.7 8.3 2.2 6 3.1 4.1c2.1 2.6 5.3 4.2 8.6 4.4V7.4c.1-2.2 2-4 4.2-4 .9 0 1.7.3 2.4.8.4.3.8.3 1.2.2l1.9-.7c-.4.9-.9 1.6-1.6 2.3.601-.1 1.3-.4 1.9-.5l.3.2c-.6.5-1.2 1.1-1.7 1.5-.1.3-.2.7-.2 1.1 0 1.9-.5 3.8-1.3 5.601A11.982 11.982 0 019.5 20.1c-2.4.2-4.9-.199-7-1.3l-.5-.7"></path></svg></a>
    ...
    <div class="row featurette shadow-lg p-3 mb-5 bg-body rounded">
      <div class="col-md-7">
        <h2 class="featurette-heading">Project Idea : <span class="text-muted">Travel Planning  </span></h2>
        <p class="card-text">

            
Travel Planning  This Travel 
Planning System enables administrators to create 
destination plans, including activities, hotels, 
and restaurants with associated costs. Users can choose and book a
 planned destination, customize activities and hotels, and view the total cost. The system displays all available options for a selected destination, allowing users to create personalized trip plans. User authentication, cost calculation, and trip history functionalities are incorporated. The user interface includes pages for registration, destination selection, plan customization, and more. Admins have a dedicated dashboard for plan management.
    ...
    <div class="row featurette shadow-lg p-3 mb-5 bg-body rounded">
      <div class="col-md-7">
        <h2 class="featurette-heading">What Sets Us   <span class="text-muted">Apart</span></h2>
        <p class="card-text">
            Embracing the latest technological advancements, Adventure Planer incorporates innovative features, 
            from real-time inventory tracking to intelligent analytics. We stay ahead of the curve, offering a 
            Adventure Planer that not only meets but exceeds the expectations of modern businesses..</p>
      </div>
      <div class="col-md-5">
        <img class="featurette-image img-fluid mx-auto" 
